...
> Deprecated. Canonical guidance now lives in [AGENTS.md](../../AGENTS.md) and [docs/engineering/development-workflow.md](../engineering/development-workflow.md). The rest of this file is historical and should not be treated as current process.
